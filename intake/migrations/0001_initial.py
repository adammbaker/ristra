...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='intake.user')),
        ...
        migrations.AddField(
            ...
            name='families',
            field=models.ManyToManyField(to='intake.HeadOfHousehold', verbose_name='Families'),
        ),
        migrations.AddField(
