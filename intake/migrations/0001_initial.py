    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('days_traveling', models.SmallIntegerField(default=0, verbose_name='Days spent traveling')),
                ('days_detained', models.SmallIntegerField(default=0, verbose_name='Days spent in detention')),
                ('notes', models.TextField(blank=True, null=True, verbose_name='Additional notes')),
                ('country_of_origin', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='intake.CountryOfOrigin')),
            ],
        ),
        migrations.CreateModel(
            name='Language',
        ...
        migrations.CreateModel(
            name='Sponsor',
            fields=[
                ('name', models.CharField(max_length=300, primary_key=True, serialize=False, verbose_name="Sponsor's name")),
                ...
                ('notes', models.TextField(blank=True, null=True, verbose_name='Additional notes')),
                ('family', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='intake.Family')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resolution_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Time the issue was resolved')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description of issue')),
                ('notes', models.TextField(blank=True, null=True, verbose_name='Additional notes')),
                ('patient', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='intake.Asylee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True, verbose_name='Additional notes')),
                ('organization', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='intake.Organization')),
            ],
        ),
        migrations.CreateModel(
            name='IntakeBus',
            fields=[
                ...
                ('arrival_time', models.DateTimeField(default=datetime.datetime(2019, 7, 3, 22, 50, 0, 528556, tzinfo=utc), verbose_name='Arrival time of bus')),
                ('number', models.CharField(blank=True, max_length=300, null=True, verbose_name='Descriptive bus name')),
                ('notes', models.TextField(blank=True, null=True, verbose_name='Additional notes')),
                ('destination', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='intake.Location')),
                ('state', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='intake.State', verbose_name='Originating state')),
            ],
        ),
        migrations.AddField(
            model_name='family',
            name='intake_bus',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='intake.IntakeBus'),
        ),
        migrations.AddField(
            model_name='family',
            name='intake_by',
        ...
        migrations.AddField(
            model_name='asylee',
            name='family',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='intake.Family'),
        ),
        migrations.AddField(
            model_name='asylee',
            name='sex',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='intake.Sex'),
        ),
        migrations.AddField(
            model_name='user',
            name='affiliations',
            field=models.ManyToManyField(to='intake.Organization', verbose_name='Affiliated organizations'),
        ),
        migrations.AddField(
            model_name='user',
            name='campaigns',
