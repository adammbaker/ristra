    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaigns', models.ManyToManyField(to='intake.Campaign', verbose_name='Active intake campaigns')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True, verbose_name='Additional notes')),
                ('arranged_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='intake.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Medical',
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True, verbose_name='Additional notes')),
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='intake.profile')),
            ],
        ),
        migrations.AddField(
            model_name='campaign',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='intake.profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_coordinator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='intake.sitecoordinator')),
            ],
        ),
        migrations.CreateModel(
            name='Lead',
        ...
        migrations.AddField(
            ...
            name='asylees',
            field=models.ManyToManyField(default=None, related_name='Dependents', to='intake.Asylee', verbose_name='Asylees'),
        ),
        migrations.AddField(
            model_name='headofhousehold',
            name='intake_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='intake.profile'),
        ),
        migrations.AddField(
            model_name='headofhousehold',
            name='languages',
