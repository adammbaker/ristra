# Generated by Django 3.1.6 on 2021-02-24 21:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('covid_vaccine_shots', models.PositiveSmallIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(2)], verbose_name='COVID vaccine shots received')),
                ('vaccine_received', models.CharField(choices=[('pfizer', 'Pfizer'), ('moderna', 'Moderna'), ('j_and_j', 'Johnson & Johnson'), ('astra_zeneca', 'AstraZeneca'), ('other', 'Other')], max_length=100, null=True, verbose_name='Vaccine manufacturer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', hashid_field.field.HashidAutoField(alphabet='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890', min_length=7, primary_key=True, serialize=False)),
                ('temperature', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='Temperature ºF')),
                ('pulse', models.CharField(blank=True, max_length=20, null=True, verbose_name='Pulse')),
                ('blood_pressure', models.CharField(blank=True, max_length=20, null=True, verbose_name='Blood pressure')),
                ('weight', models.PositiveSmallIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(2)], verbose_name='Weight (lbs)')),
                ('height', models.CharField(blank=True, max_length=20, null=True, verbose_name='Height')),
                ('oxgyen_level', models.CharField(blank=True, max_length=20, null=True, verbose_name='Oxygen level')),
                ('vaccines_received', models.CharField(blank=True, max_length=300, null=True, verbose_name='Vaccines received')),
                ('allergies', models.CharField(blank=True, max_length=200, null=True, verbose_name='Allergies')),
                ('medications', models.CharField(blank=True, max_length=200, null=True, verbose_name='Medications')),
                ('chronic_medical_problems', models.CharField(blank=True, max_length=200, null=True, verbose_name='Allergies')),
                ('symptoms', models.TextField(blank=True, null=True, verbose_name='Symptoms observed')),
                ...
                ('follow_up_needed', models.TextField(blank=True, null=True, verbose_name='Follow up needed')),
                ('notes', models.TextField(blank=True, null=True, verbose_name='Additional notes')),
